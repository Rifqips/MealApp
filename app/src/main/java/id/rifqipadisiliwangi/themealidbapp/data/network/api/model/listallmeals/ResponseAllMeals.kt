package id.rifqipadisiliwangi.themealidbapp.data.network.api.model.listallmeals
...
@Keep
data class ResponseAllMeals(
    @SerializedName("meals")
    val meals: List<MealAll>?
)
...
fun MealAll.toMeal() = AllMealsItem(
...
fun Collection<MealAll>.toMealsList() = this.map { it.toMeal() }